...
class MargPosHeaderCard extends StatelessWidget {
  final void Function(OcrScanResultModel result) onOcrScanned;

  const MargPosHeaderCard({super.key, required this.onOcrScanned});
          ...
          InkWell(
            onTap: () async {
              final result = await OcrScannerModal.show(
                context,
                initialType: OcrDocumentType.prescription,
              );
              if (result != null) {
                onOcrScanned(result);
              }
